# mdl-repeat Output Quality Enhancement Proposal — v3

**Changes from v2**: integrated R2 reviews. 4 new bio items (BIO-N7..N10), 3 new eng items (ENG-N8..N10). Q4/Q6 audits answered. New Tier 1.5b "multi-chromosome correctness" theme added (systemic — not just N8/N9). Stage B Fix 1 status clarified (BIO-N8). BIO-N2 test redesigned per BIO-N7 + N10.
